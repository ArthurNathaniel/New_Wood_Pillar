...
<body>
            ...
            <div class="col-md-9">
                <div class="grid">
                    <div class="one">
                        ...
                        <h4>Quality</h4>
                        <p>
                            Crafting excellence, ensuring satisfaction.
                        </p>
                    </div>
                    <div class="one one_">
                        ...
                        <h4>Craftsmanship</h4>
                        <p>
                            Mastering art, creating wonders.
                        </p>
                    </div>
                    <div class="one">
                        <h1> <i class="fas fa-tree"></i></h1>
                        <h4>Sustainability</h4>
                        <p>
                            Nurturing nature, securing tomorrow.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section>
        <div class="welcome row">
            <div class="col-md-5 welcome_img">
    ...
    <section>
        <div class="keys">
            <div class="card">
                <img class="card-img-top" src="./images/concession.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    <h4 class="card-title">
                        Our Concessions
                    </h4>
            ...
            <div class="card card2">
                <img class="card-img-top" src="./images/what_we_do.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
