            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="about_us.php">Wood Pillar</a></li>
                        <li><a class="dropdown-item" href="corperate_responsibility.php">Corporate Responsibility</a></li>
                        <li><a class="dropdown-item" href="objective_and_mision.php">Objectives & Mission</a></li>
                    </ul>
                </li>

                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="product_range.php">Product Range</a>
                </li>
